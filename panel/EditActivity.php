...
<head>
    ...
    <title>Barilifestyle Edit Activities</title>
</head>

<body>
    <div onclick="showMenu(false)" id="cover"></div>
    <p id="activity_id" style="display: none;"><?php echo $id; ?></p>
    <div class="container">
        <div class="side_menu">
        ...
        <div class="main_content">
            ...
            <div class="pageHolder">
                <h1 id="programName">Edit Activities</h1>
                ...
                <div class="addActivity">
                    ...
                    <br>
                    <button onclick="checkFields()">Save</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="<?php bloginfo('template_directory'); ?>/panel/js/activities/editactivity.js"></script>
</body>
