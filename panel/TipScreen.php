...
<head>
    ...
    <link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/panel/css/tips.css">
...
<body>
    ...
    <div class="container">
        ...
        <div class="main_content">
            ...
            <div class="tip_head">
                ...
                <a href="http://localhost/wordpress/create-tip/">Post a Tip</a>
            </div>
            <div class="tip_list">
                <!-- <div class="tip">
                    <img src="" alt="" class="tip_img">
                    <div class="details">
                        <h3>Tip Title goes here</h3>
                        <div class="information">
                            <img src="" alt="">
                            <p>by Name here</p>
                            <p>Date Posted</p>
                        </div>
                        <p id="tip_body">Tip body will be what we see over on this side</p>
                        <div class="actions">
    ...
    <script src="<?php bloginfo('template_directory'); ?>/panel/js/tips/tips.js"></script>
</body>
