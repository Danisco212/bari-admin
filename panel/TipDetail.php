...
<body>
    <p id="post_id" style="display: none;"><?php echo $id; ?></p>
    ...
    <div class="container">
        ...
        <div class="main_content">
            ...
            <div class="head_holder">
                <h1 style="margin-right: 20px;">Tip Detail</h1>
    ...
    <script src="<?php bloginfo('template_directory'); ?>/panel/js/tips/tipDetail.js"></script>
</body>
