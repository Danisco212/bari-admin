...
<body>
        ...
        <div class="main_content">
            ...
            <div class="pageHolder">
                <div class="header_holder">
                    <h1 id="programName">Create New Workout</h1>
                    <button onclick="createProgram()">Create Workout</button>
                </div>
    ...
    <script src="<?php bloginfo('template_directory'); ?>/panel/js/workouts/createProgram.js"></script>
</body>
