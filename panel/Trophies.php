...
<head>
    ...
    <link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/panel/css/trophies.css">
...
<body>
        ...
        <div class="main_content">
            ...
            <div class="pageHolder">
                <div class="header_holder">
                    <h1>Trophies</h1>
                    <a href="http://localhost:8888/Bari/admin-create-trophy/">Add Trophy</a>
                </div>
    ...
    <script src="<?php bloginfo('template_directory'); ?>/panel/js/trophies/trophies.js"></script>
</body>
